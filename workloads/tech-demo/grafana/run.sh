...
# XXX Workaround: wait until the grafana server has started
...
curl -XPOST admin:admin@localhost:3000/api/dashboards/import -H "Content-Type: application/json" -d @/var/lib/grafana/initial/internal-dashboard.json
